...
import com.werner.bugtracker.domain.Label;
import com.werner.bugtracker.repository.LabelRepository;
...
/**
 * REST controller for managing {@link com.werner.bugtracker.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
