  ...
  return (
    <div>
      <h2 id="project-heading">
        <Translate contentKey="bugTrackerJHipsterApp.project.home.title">Projects</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="bugTrackerJHipsterApp.project.home.createLabel">Create new Project</Translate>
        </Link>
      </h2>
        ...
        {projectList && projectList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="bugTrackerJHipsterApp.project.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bugTrackerJHipsterApp.project.home.notFound">No Projects found</Translate>
            </div>
          )
        )}
      </div>
