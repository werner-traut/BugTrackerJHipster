  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bugTrackerJHipsterApp.project.home.createOrEditLabel">
            <Translate contentKey="bugTrackerJHipsterApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
