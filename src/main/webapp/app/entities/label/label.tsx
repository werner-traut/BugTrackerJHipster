...
export const Label = (props: ILabelProps) => {
  ...
  return (
    <div>
      <h2 id="label-heading">
        <Translate contentKey="bugTrackerJHipsterApp.label.home.title">Labels</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="bugTrackerJHipsterApp.label.home.createLabel">Create new Label</Translate>
        </Link>
      </h2>
        ...
        {labelList && labelList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bugTrackerJHipsterApp.label.home.notFound">No Labels found</Translate>
            </div>
          )
        )}
      </div>
