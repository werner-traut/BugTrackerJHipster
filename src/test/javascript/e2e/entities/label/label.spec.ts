...
describe('Label e2e test', () => {
  ...
  it('should load create Label page', async () => {
    ...
    expect(await labelUpdatePage.getPageTitle().getAttribute('id')).to.match(/bugTrackerJHipsterApp.label.home.createOrEditLabel/);
  ...
  it('should delete last Label', async () => {
    ...
    expect(await labelDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/bugTrackerJHipsterApp.label.delete.question/);
